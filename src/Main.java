...
public class Main {
    final static String CHARS = "abc";
    final static int COUNT_OF_TEXT = 10_000;
    final static int LENGTH_OF_TEXT = 100_000;
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        new Thread(() -> {
            for (int i = 0; i < COUNT_OF_TEXT; i++) {
                String text = generateText(CHARS, LENGTH_OF_TEXT);
                try {
        ...
        new Thread(() -> {
            ...
            System.out.println("Максимальное количество букв 'a' в строке " + sumA);
        }).start();
        ...
        new Thread(() -> {
            ...
            System.out.println("Максимальное количество букв 'b' в строке " + sumB);
        }).start();
        ...
        new Thread(() -> {
            ...
            System.out.println("Максимальное количество букв 'c' в строке " + sumC);
        }).start();
    }
